...
public class MovieState extends BaseAppState {
    ...
    private void startVideo(Application app) {
        ...
        textureMovie = new TextureMovie(app, mediaPlayer, TextureMovie.LetterboxMode.VALID_SQUARE);
        ...
        Material mat = new Material(app.getAssetManager(), "Shaders/MovieShader/MovieShader.j3md");
        ...
        // logger.info("quadWidth: " + quadWidth + " quadHeight: " + quadHeight);
