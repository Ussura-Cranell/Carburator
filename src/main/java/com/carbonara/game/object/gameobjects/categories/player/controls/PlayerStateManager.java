...
import com.carbonara.game.object.gameobjects.categories.player.PlayerCharacter;
...
public class PlayerStateManager extends BaseAppState {
    ...
    public PlayerMovingControl getPlayerMovingControl() {
        return playerMovingControl;
    }

    public CameraInteraction getCameraInteraction() {
        return cameraInteraction;
    }
}
