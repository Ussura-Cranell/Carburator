...
public class StorageControlSystemPage extends AbstractSpaceshipSystemPage{
    public StorageControlSystemPage(Node point, float scale) {
        super(point, scale);
    }
